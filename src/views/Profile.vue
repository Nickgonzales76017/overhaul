  ...
  methods: {
    fetchData() {
      ...
      .then((response) =>  {
        ...
        SocketioService.setupSocketConnection(this.post)
        SocketioService.listAllOnline(this.$route.params.id);
        this.loading = false
      })
    }
        ...
        <div 
            ...
            <nav :class="{'flex': open, 'hidden': !open}"
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div v-show="open" x-transition:enter="transition ease-out duration-100"
        ...
        <div class="md:flex no-wrap md:-mx-2 ">
            ...
            <div class="w-full md:w-3/12 md:mx-2">
                ...
                <div class="bg-white p-3 border-t-4 border-green-400">
                    ...
                    <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">{{ post.fname }}</h1>
                    ...
                    <div class="text-gray-700">
                        <div class="grid md:grid-cols-2 text-sm">
                            ...
                            <div class="grid grid-cols-2">
                                ...
                                <div class="px-4 py-2">
                                    <a class="text-blue-800" href="mailto:{{ post.email }}">{{ post.email }}</a>
                                </div>
                            </div>
                            <div class="grid grid-cols-2">
